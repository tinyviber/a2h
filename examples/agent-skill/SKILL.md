...
Drop-in skill. Copy this file into an agent runner's skill directory; the
normative spec lives in [`docs/protocol.md`](../../docs/protocol.md).
...
full field reference is [`docs/protocol.md`](../../docs/protocol.md).
